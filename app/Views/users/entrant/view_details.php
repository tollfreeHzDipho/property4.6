...
<div class="app-title">
  <div>
    <h1><i class="fa fa-bars"></i> Properties Entered by: <?php echo ucwords(strtolower($staff_name['first_name']." ".$staff_name['last_name']." ".$staff_name['other_names'])); ?></h1>
      ...
      <div class="bs-component">
          ...
          <div class="tab-content" id="myTabContent">
            ...
            <div class="table-responsive">
              <table class="table table-hover table-sm table-bordered table-stripped" id="tblProperty_pa_entrant" >
                <thead>
                  <tr >
                    <th>#Serial Number</th>
...
var handleDataTableButtons = function(tabClicked) {
  <?php $this->view('users/entrant/table_js'); ?>
