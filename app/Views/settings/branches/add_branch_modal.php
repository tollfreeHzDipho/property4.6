...
<div class="modal fade" id="add_branch" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-md"  role="document">
        <div class="modal-content">
            <form method="post" class="formValidate" action="<?php echo base_url(); ?>create_branch" id="formBranch" name="formBranch">
                <div class="modal-header">
                      <button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">X</span></button>

                      <h4 ><center> Branch </center>
                      </h4>
                ...
                <div class="modal-body">
                    <input type="hidden" name="id">
                        <div class="form-group row">
                            <label class="col-lg-4 col-form-label">Branch Name<span class="text-danger">*</span></label>
                            <div class="col-lg-8 form-group">
                                <input placeholder="" required class="form-control" name="branch_name" type="text">
                            </div>
                            <span  class="help-block with-errors" aria-hidden="true"></span>
                        </div>
                       
                        <div class="form-group row">
                            <label class="col-lg-4 col-form-label">Branch Address</label>
                            <div class="col-lg-8 form-group">
                                <textarea class="form-control" rows="2" required name="branch_address" id="branch_address"></textarea>
                            </div>
                        </div>
